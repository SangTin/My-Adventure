#include <State/QuitDialouge.hpp>
...
void QuitDialouge::init(){
    ...
    transform->centered();
    dialog->add_component<SpriteComponent>("assets/img/states/QuitDialouge/Dialog.png", BG_WIDTH, BG_HEIGHT);
    ...
    Cat->add_action("Idle", "assets/img/states/QuitDialouge/CatCharacter.png", 4, 200);
    Cat->play_action("Idle");
}

void QuitDialouge::update(){
    GameState::update();
...
void QuitDialouge::render(){
    ...
    FontManager::draw_text("Are you sure you want to quit?", &textDst, 15, NULL, {107, 75, 91, 255});
}